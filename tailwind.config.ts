  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "slide-up-1": "slideUp 0.3s ease-out 0.05s both",
        "slide-up-2": "slideUp 0.3s ease-out 0.1s both",
        "slide-up-3": "slideUp 0.3s ease-out 0.15s both",
        "slide-up-4": "slideUp 0.3s ease-out 0.2s both",
        "slide-up-5": "slideUp 0.3s ease-out 0.25s both",
